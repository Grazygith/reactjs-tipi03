...
//middleware de autencação

const verficarLogin = (req, res, next) => {
...
app.post("/login", (req, res) => {
    ...
    db.query(sql, [email], async (err, data) => {
        ...
        if (data.length === 0) {
            return res.status(401).json({ error: "Email ou senha inavalidos" });
        }
...
// Listar os usuarios (PROTEGIDOS) - via get
app.get("/cadastrados", verficarLogin, (req, res) => {
...
// buscar  por id -  via get
app.get("/cadastrados/:id", verficarLogin, (req, res) => {
...
//  Atualizar (protegido) -  via put

app.put("/cadastrados/:id", verficarLogin, (req, res) => {
